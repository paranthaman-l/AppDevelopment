...
import static com.paranthaman.vendormanagementsystem.model.enumerate.Role.ORGANIZATION;
        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
                httpSecurity.cors(corsConfirguarationSource -> corsConfirguarationSource
                                ...
                                .authorizeHttpRequests(authorize -> authorize
                                                ...
                                                .requestMatchers(Api.SERVICE_REQUEST + "/**").permitAll()
                                                ...
                                                .hasAnyRole(ADMIN.name(), ORGANIZATION.name())
                                                .requestMatchers(GET, Api.ORGANIZATION + "/**")
                                                .hasAnyAuthority(ADMIN_READ.name(), ORGANIZATION_READ.name())
                                                .requestMatchers(POST, Api.ORGANIZATION + "/**")
                                                .hasAnyAuthority(ADMIN_CREATE.name(), ORGANIZATION_CREATE.name())
                                                .requestMatchers(PUT, Api.ORGANIZATION + "/**")
                                                .hasAnyAuthority(ADMIN_UPDATE.name(), ORGANIZATION_UPDATE.name())
                                                .requestMatchers(DELETE, Api.ORGANIZATION + "/**")
                                                .hasAnyAuthority(ADMIN_DELETE.name(), ORGANIZATION_DELETE.name())
