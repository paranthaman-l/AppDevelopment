...
const UpdateService = ({ addRef, setShowUpdateService,updateService }) => {
    const [stage, setStage] = useState(1);
    const [paymentPolicy, setPaymentPolicy] = useState([]);
    const [input, setInput] = useState("");
    const [images, setImages] = useState([]);
    const [service, setService] = useState({});
    const addPaymentPolicy = (e) => {
        e.preventDefault();
        if (input) {
            setPaymentPolicy([...paymentPolicy, input]);
            setInput("");
        }
    };
    useEffect(() => {
        setService({ ...service, "paymentPolicy": paymentPolicy })
    }, [paymentPolicy])
    ...
    const handleUpdateService = async (e) => {
        e.preventDefault();
        console.log(service);
        await ServiceService.putService(service).then((response) => {
    ...
    return (
        <form onSubmit={handleUpdateService} className="w-full  z-30 bg-black bg-opacity-20 flex justify-center items-center fixed h-screen">
            <div ref={addRef} className="lg:col-start-2  h-[75%]  absolute top-10 rounded max-w-4xl  bg-white col-span-12 lg:col-span-10 grid grid-cols-6 gap-x-8 gap-y-10 border-b border-darkGray/10 pb-12 mx-auto">
                <div className="p-4 col-span-6 md:col-span-2 ">
                    <div className="grid grid-cols-5">
                        ...
                        <button type="submit" className="btn rounded-md bg-indigo px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo2  focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo min-w-[100px]">Update</button>
                    ...
                    <div className="p-4 col-span-6 md:col-span-4 overflow-y-scroll">
                        <div className="mx-auto grid grid-cols-2 gap-x-8 gap-y-10">
                            <div className="col-span-2 sm:col-span-1">
                                <label htmlFor="serviceName" className="block text-sm font-medium leading-6 text-darkGray">Service Name</label>
                                <div className="mt-2">
                                    <input value={service?.serviceName} onChange={handleChange} type="text" name="serviceName" id="serviceName" autoComplete="given-name" className="block w-full indent-2 rounded-md border-0 py-1.5 text-darkGray shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                </div>
                            </div>
                            <div className="col-span-2 sm:col-span-1">
                                <label htmlFor="serviceType" className="block text-sm font-medium leading-6 text-darkGray">Service Type</label>
                                <div className="mt-2">
                                    <input value={service?.serviceType} onChange={handleChange} type="text" name="serviceType" id="serviceType" autoComplete="given-name" className="block w-full indent-2 rounded-md border-0 py-1.5 text-darkGray shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                </div>
                            </div>
                            <div className="col-span-2">
                                <label htmlFor="serviceDescription" className="block text-sm font-medium leading-6 text-darkGray">Service Description</label>
                                <div className="mt-2">
                                    <textarea value={service?.serviceDescription} onChange={handleChange} maxLength={200} type="text" name="serviceDescription" id="serviceDescription" autoComplete="given-name" className="block w-full  p-2 rounded-md border-0 py-1.5 text-darkGray shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                </div>
                            </div>
                            <div className="col-span-2 sm:col-span-1">
                            ...
                            <div className="col-span-2 sm:col-span-1">
                                <label htmlFor="dateOfStart" className="block text-sm font-medium leading-6 text-darkGray">Date of Start</label>
                                <div className="mt-2">
                                    <input value={service?.dateOfStart} onChange={handleChange} type="date" name="dateOfStart" id="dateOfStart" autoComplete="given-name" className="block w-full indent-2 rounded-md border-0 py-1.5 text-darkGray shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                </div>
                            </div>
                        ...
                        <div className="p-4 col-span-6 md:col-span-4 overflow-y-scroll">
                            <div className="mx-auto grid grid-cols-2 gap-x-8 gap-y-10">
                                ...
                                <div className="col-span-2">
                                    ...
                                    <div className="mt-2">
                                        <input value={service?.serviceCost} onChange={handleChange} id="serviceCost" name="serviceCost" type="text" autoComplete="Service" className="block w-full indent-2 rounded-md border-0 py-1.5 text-darkGray shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                    </div>
                                </div>
                                <div className="col-span-2 sm:col-span-1">
                                    <label htmlFor="serviceDuration" className="block text-sm font-medium leading-6 text-darkGray">Service Duration</label>
                                    <div className="mt-2">
                                        <input value={service?.serviceDuration} onChange={handleChange} type="text" name="serviceDuration" id="serviceDuration" autoComplete="given-name" className="block w-full indent-2 rounded-md border-0 py-1.5 text-darkGray shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                    </div>
                                </div>
                                <div className="col-span-2 sm:col-span-1">
                                    <label htmlFor="serviceAvailability" className="block text-sm font-medium leading-6 text-darkGray">Service Availability</label>
                                    <div className="mt-2">
                                        <input value={service?.serviceAvailability} onChange={handleChange} type="text" name="serviceAvailability" id="serviceAvailability" autoComplete="given-name" className="block w-full indent-2 rounded-md border-0 py-1.5 text-darkGray shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                    </div>
                                </div>
                                {/* <div className="col-span-2">
                        ...
                        stage === 3 ?
                            <div className="col-span-3">
                                <div className=" mx-auto mt-8 p-4  rounded">
                                    ...
                                    <ul className="mt-4">
                                        {service?.paymentPolicy?.map((policy, index) => (
                                ...
                                <div className="w-full col-span-2 mt-10">
                                    <div className="flex">
                                        {images?.map((image, index) => {
                                            return (
                                                <img key={index} className="w-28 h-40" src={image} alt="" />
                                            )
                                        })}
                                    </div>
                                    <FileUploader service={service} setService={setService} setImages={setImages} />
                                </div> :
                                <div className="p-4 col-span-6 md:col-span-4 overflow-y-scroll">
                                    <div className="mx-auto grid grid-cols-2 gap-x-8 gap-y-10">
                                        <div className="col-span-2 sm:col-span-1">
                                        ...
                                        <div className="col-span-2">
                                            ...
                                            <div className="mt-2">
                                                <input value={service?.email} onChange={handleChange} id="email" name="email" type="email" autoComplete="email" className="block w-full indent-2 rounded-md border-0 py-1.5 text-darkGray shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                            </div>
                                        </div>
                                        <div className="col-span-2 sm:col-span-1">
                                            <label htmlFor="contact" className="block text-sm font-medium leading-6 text-darkGray">Mobile No</label>
                                            <div className="mt-2">
                                                <input value={service?.contact} onChange={handleChange} type="text" name="contact" id="contact" autoComplete="given-name" className="block w-full indent-2 rounded-md border-0 py-1.5 text-darkGray shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                            </div>
                                        </div>
                                        <div className="col-span-2 sm:col-span-1">
                                            <label htmlFor="dateOfBirth" className="block text-sm font-medium leading-6 text-darkGray">DOB</label>
                                            <div className="mt-2">
                                                <input value={service?.dateOfBirth} onChange={handleChange} type="date" name="dateOfBirth" id="dateOfBirth" autoComplete="given-name" className="block w-full indent-2 rounded-md border-0 py-1.5 text-darkGray shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                            </div>
                                        </div>
                                        <div className="col-span-2">
                                            <label htmlFor="address" className="block text-sm font-medium leading-6 text-darkGray">Address</label>
                                            <div className="mt-2">
                                                <textarea value={service?.address} onChange={handleChange} type="text" name="address" id="address" autoComplete="given-name" className="block w-full  p-2 rounded-md border-0 py-1.5 text-darkGray shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="mt-6 flex items-center justify-end gap-x-6">
