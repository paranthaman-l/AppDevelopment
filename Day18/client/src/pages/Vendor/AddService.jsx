...
const AddService = ({ addRef,setShowAddService }) => {
    ...
    const handleAddService =async (e) => {
        e.preventDefault();
        setService({...service,"createdBy":vendor?.user?.name})
        await ServiceService.addService(service,vendor?.vid).then((response)=>{
    ...
    return (
        <form onSubmit={handleAddService} className="w-full  z-30 bg-black bg-opacity-20 flex justify-center items-center fixed h-screen">
